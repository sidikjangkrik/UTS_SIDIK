...
import com.example.testtravel.database.DatabaseHelper;
import com.example.testtravel.session.SessionManager;
...
public class BookKeretaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] asal = {"Medan", "Aceh", "Jambi", "Lampung", "Pekanbaru"};
        final String[] tujuan = {"Medan", "Aceh", "Jambi", "Lampung", "Pekanbaru"};
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("Medan") && sTujuan.equalsIgnoreCase("Medan"))
                            || (sAsal.equalsIgnoreCase("Aceh") && sTujuan.equalsIgnoreCase("Aceh"))
                            || (sAsal.equalsIgnoreCase("Jambi") && sTujuan.equalsIgnoreCase("Jambi"))
                            || (sAsal.equalsIgnoreCase("Lampung") && sTujuan.equalsIgnoreCase("Lampung"))
                            || (sAsal.equalsIgnoreCase("Pekanbaru") && sTujuan.equalsIgnoreCase("Pekanbaru"))) {
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("Medan") && sTujuan.equalsIgnoreCase("Aceh")) {
            hargaDewasa = 100000;
            hargaAnak = 70000;
        } else if (sAsal.equalsIgnoreCase("Medan") && sTujuan.equalsIgnoreCase("Jambi")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("Medan") && sTujuan.equalsIgnoreCase("Pekanbaru")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("Medan") && sTujuan.equalsIgnoreCase("Lampung")) {
            hargaDewasa = 180000;
            hargaAnak = 140000;
        } else if (sAsal.equalsIgnoreCase("Aceh") && sTujuan.equalsIgnoreCase("Medan")) {
            hargaDewasa = 100000;
            hargaAnak = 70000;
        } else if (sAsal.equalsIgnoreCase("Aceh") && sTujuan.equalsIgnoreCase("Aceh")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("Aceh") && sTujuan.equalsIgnoreCase("Jambi")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        } else if (sAsal.equalsIgnoreCase("Aceh") && sTujuan.equalsIgnoreCase("Lampung")) {
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("Lampung") && sTujuan.equalsIgnoreCase("Medan")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("Lampung") && sTujuan.equalsIgnoreCase("Aceh")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("Lampung") && sTujuan.equalsIgnoreCase("Pekanbaru")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("Lampung") && sTujuan.equalsIgnoreCase("Jambi")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("Pekanbaru") && sTujuan.equalsIgnoreCase("Medan")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("Pekanbaru") && sTujuan.equalsIgnoreCase("Aceh")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        } else if (sAsal.equalsIgnoreCase("Pekanbaru") && sTujuan.equalsIgnoreCase("Jambi")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("Pekanbaru") && sTujuan.equalsIgnoreCase("Lampung")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("Jambi") && sTujuan.equalsIgnoreCase("Medan")) {
            hargaDewasa = 180000;
            hargaAnak = 140000;
        } else if (sAsal.equalsIgnoreCase("Jambi") && sTujuan.equalsIgnoreCase("Aceh")) {
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("Jambi") && sTujuan.equalsIgnoreCase("Pekanbaru")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("Jambi") && sTujuan.equalsIgnoreCase("Jambi")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;
        }
